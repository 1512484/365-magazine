<template>
    <div class="footer-section">
        <div class="container sm:flex py-14">
            <div class="sm:w-2/3 w-full px-5 sm:py-14 py-10 sm:border-r border-[#ddd]">
                <div class="max-w-[595px] mx-auto">
                    <h2 class="juana font-light text-center max-w-[474px] mx-auto leading-[1.1] mb-12 sm:max-w-[unset] max-w-[200px] animate-item">
                        <animation-title title="Sign Up To Newsletter" class="sm:text-[50px] text-4xl" animation />                        
                    </h2>
                    <SubscribeInput />
                </div>
            </div>
            <div class="sm:w-1/3 w-full px-5 sm:py-14 py-10 animate-item">
                <div class="flex flex-col sm:items-start items-center max-w-[383px] mx-auto">
                    <h3 class="text-3xl mb-10 opacity-down">
                        <span>365 Magazine</span>
                    </h3>
                    <div class="sm:text-left text-center footer-link">
                        <a href="#" class="sm:text-lg text-base footer-link-item opacity-down">
                            <span>About Us</span>
                        </a>
                        <a href="#" class="sm:text-lg text-base footer-link-item opacity-down">
                    ...
                    <div class="social">
                        <a href="#" class="social-item opacity-down">
                            <span>
